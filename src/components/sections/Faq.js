...
<Box>
  ...
  The amount of royalties was fixed at 5% to finance Chip Pands Club's projects. We have the ambition to organize multiple events around the world in order to strengthen the community and build a network of entrepreneurs and investors with the same mindset and common interests.
  </Accordion>
</Box>
<Box>
...
You will be able to use your NFT as an avatar in the Metaverse and our future video game. Holding also means that you are part of an exclusive network of investors and entrepreneurs.
  ...
  <Accordion ScrollTrigger={ScrollTrigger} title="WHAT ARE Chip Pands?
" >
Each panda has a unique microchip. The chip will record something.
  </Accordion>

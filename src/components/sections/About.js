  ...
  return (
    <Section id="about">
      <Container>
        ...
        <Box> 
        <Title>
        Welcome To The <br /> ChipPandas Club.
        </Title>
        <SubText>
        Chip Pands CLUB is a private collection of NFTs—unique digital collectibles. Chip Pands are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS.
        </SubText>
        <SubTextLight>
